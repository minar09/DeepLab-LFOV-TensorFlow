...
def get_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Extract model parameters of DeepLab-LargeFOV from the provided .caffemodel.")
...
def main():
    ...
    for name, item in net.params.iteritems():
        # See the explanataion on filter formats above.
    ...
    net_weights = dict()
    for name, item in net.params.iteritems():
        # See the explanation on filter formats above.
